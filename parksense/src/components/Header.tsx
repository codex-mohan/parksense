      ...
      <div className="flex items-center justify-between px-6 py-3">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-neon-cyan to-neon-magenta flex items-center justify-center">
        ...
        <div className="hidden md:flex items-center gap-1 text-xs">
          ...
          <span className="px-2 py-1 rounded-full bg-neon-magenta/10 text-neon-magenta border border-neon-magenta/20">
